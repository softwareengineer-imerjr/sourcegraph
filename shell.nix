...
mkShell {
  ...
  BAZEL_ACTION_PATH = with pkgs; lib.makeBinPath [ nix bashInteractive stdenv.cc coreutils curl unzip zip gzip gnutar gnugrep gnused git patch openssh findutils perl python39 which postgresql_13 ];
