...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:/JUg9V1+xh+qBn8A6ec/l15ETPaMaBqxkjz+gg63dNk=",
        version = "v1.47.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:oe3vqcGftyk40icfLymhhhNysAwk0NfiwkDi2GTPMXs=",
        version = "v1.19.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:wl5dxN1NONhTDQD9uaEvNsDRX29cBmGED/nl0jkWlt4=",
        version = "v1.40.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        patch_args = ["-p1"],
        patches = [
            "//third_party/com_github_chainguard_dev_go_apk:debug.patch",
        ],
    ...
    go_repository(
        ...
        sum = "h1:kNNf3BYNYn/Zkig0B89fma12l36VLcYSGu7OnaRlRDg=",
        version = "v0.93.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        patch_args = ["-p1"],
        patches = [
            "//third_party/dev_chainguard_apko:debug.patch",
        ],
    ...
    go_repository(
        ...
        sum = "h1:dJhgKCog+FEZt7OwAYV1R+o/RZPmE8aqFoptmxSWyr8=",
        version = "v0.6.0",
    )
    go_repository(
